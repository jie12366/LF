...
public interface MoneyManageMapper {
     ...
     * @return
     */
    @Insert("insert into money_manage(reimburse,deal,content,spend,balance) " +
            "values(#{reimburse},#{deal},#{content},#{spend},#{balance})")
    int saveMoneyManage(String reimburse,String deal,String content,float spend,float balance);
    ...
    int updateMoneyManage(String reimburse,String deal,String content,float spend,int id);
